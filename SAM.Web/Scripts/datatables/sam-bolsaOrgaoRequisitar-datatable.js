BolsaOrgaoRequisitarDataTable = (function () {
    let tableName = '#tableBolsaOrgaoRequisitar';
    ...
    var _form;
    BolsaOrgaoRequisitarDataTable.prototype.Load = function (form) {
        _form = form;
        criarTabelaBolsaOrgaoRequisitar(form);
        consultarBolsaOrgaoRequisitar();
    }
    let consultarBolsaOrgaoRequisitar = function () {
        $(actionConsulta).click(function () {
            $(tableName).DataTable().clear();
            $(tableName).DataTable().destroy();
            criarTabelaBolsaOrgaoRequisitar(_form);
        });
    };
    //criação
    criarTabelaBolsaOrgaoRequisitar = function (form) {
        ...
        let table = $(tableName).DataTable({
            ...
            "ajax":
            {
                "url": "IndexJSONResultBolsaOrgaoRequisitar",
                "type": "POST",
                "headers": {
