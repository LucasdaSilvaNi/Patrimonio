...
namespace SAM.Web.Context
{
    public class SupportContext : DbContext
    {
        ...
        public SupportContext() : base(new SqlConnection(ConfigurationManager.ConnectionStrings["SAMContext"].ConnectionString), false)
        {}


        public DbSet<AttachmentSupport> AttachmentSupports { get; set; }
        public DbSet<HistoricoCampo> HistoricoCampos { get; set; }
        public DbSet<HistoricSupport> HistoricSupports { get; set; }
        public DbSet<Historico> Historicos { get; set; }
        public DbSet<ManagedSystem> ManagedSystems { get; set; }
        public DbSet<ManagerUnit> ManagerUnits { get; set; }
        public DbSet<Module> Modules { get; set; }
        public DbSet<Support> Supports { get; set; }
        public DbSet<SupportStatusProdesp> SupportStatusProdesps { get; set; }
        public DbSet<SupportStatusUser> SupportStatusUsers { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Configurations.Add(new AttachmentSupportMap());
            ...
            modelBuilder.Configurations.Add(new SupportStatusProdespMap());
            modelBuilder.Configurations.Add(new SupportStatusUserMap());
            modelBuilder.Configurations.Add(new SupportTypeMap());
