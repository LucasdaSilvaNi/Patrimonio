...
{
    public class AccountingClosingExcluidos
    {
        ...
        public int? AuditoriaIntegracaoIdEstorno { get; set; }

        public virtual AuditoriaIntegracao RelatedAuditoria { get; set; }

        public virtual AuditoriaIntegracao RelatedAuditoriaEstorno { get; set; }
    }
}