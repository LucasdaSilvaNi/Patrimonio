DROP PROCEDURE FECHAMENTO_RECALCULO_ASSETID
GO

--CREATE PROCEDURE [dbo].[FECHAMENTO_RECALCULO_ASSETID]  --456     
--(
--@AssetId int   
--)            
--AS              
...
-- where Status = 1 and AssetId = @AssetId        
...
--					 @DepreciationPriceGravar = a.DepreciationByMonth,  @DepreciationPrice = a.DepreciationByMonth , 
--					 @MonthUsed = a.monthUsed - 1 , @ResidualValueCalc = a.ResidualValueCalc , 
