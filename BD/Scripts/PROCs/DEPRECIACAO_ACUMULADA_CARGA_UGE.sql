DROP PROCEDURE DEPRECIACAO_ACUMULADA_CARGA_UGE
GO

--CREATE PROCEDURE [dbo].[DEPRECIACAO_ACUMULADA_CARGA_UGE]  --456     
--(
--	@managerUnitId int
--)            
--AS              
...
-- DECLARE asset_cursoruge CURSOR FOR      
...
-- OPEN asset_cursoruge;              
-- FETCH NEXT FROM asset_cursoruge into @assetIdCurrentLoop;              
...
-- CLOSE asset_cursoruge              
-- DEALLOCATE asset_cursoruge              
