DROP procedure EXECUTAR_DEPRECIAO_MATERIALITEMCODE
GO

--CREATE PROCEDURE [dbo].[EXECUTAR_DEPRECIAO_MATERIALITEMCODE](
-- @ManagerUnitId INT,
...
--   AND a.MaterialItemCode = @MaterialItemCode
--   AND a.NumberIdentification = @Chapa
